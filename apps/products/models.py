...
class Category(models.Model):
    ...
    image = models.ImageField(upload_to='categories/icons/', null=True, blank=True, storage=MediaCloudinaryStorage(), max_length=600)
...
class Product(models.Model):
    ...
    thumbnail = models.ImageField(upload_to=get_thumbnail_path, storage=MediaCloudinaryStorage(), max_length=600)
...
class ProductImage(models.Model):
    ...
    image = models.ImageField(upload_to='products/gallery/', storage=MediaCloudinaryStorage(), max_length=600)

class HomeBanners(models.Model):
    title = models.CharField(max_length=200)
    image = models.ImageField(upload_to='banners/', storage=MediaCloudinaryStorage(), max_length=600)
