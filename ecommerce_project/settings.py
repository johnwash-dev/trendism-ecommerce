...
SECRET_KEY = 'django-insecure-!8ep)-90&!o&!)i7o+8k(-vpef0)q$f5fzqfd%9is5sy^ml8_+'
...
# 5. User model-la username field-ye illana ithai add pannunga
...
EMAIL_HOST_PASSWORD = 'oqtz fqza flop webu'
